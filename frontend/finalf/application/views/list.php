            ...
            <div class="bg-faded rounded p-5">
             <h2 class="section-heading mb-4">
              ...
              <p class="mb-0">D Bit tim čine : Ratko Amanović, David Milićević i Andrija Veljković. :')</p>-->
                <div class ="row">
                    <div class="col-xl-9 ">
                        <table class ="table table-striped table-hover">
                            ...
                            echo "<tr><td scope = 'col'>".$numera->autor."</td><td scope = 'col'><a href =".site_url("$controller/pesma")."?id=".$numera->id.">"
                                     .$numera->delo. "</a></td>";
                            }
                ...
                <div class ="row">
                <div class ="col-xl-7">
                    <form action ="<?php  echo site_url("$controller/muzika");?>" method = "post">
