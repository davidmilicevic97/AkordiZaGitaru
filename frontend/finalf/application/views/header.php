          ...
          <li class="nav-item px-lg-4 dropdown">
            <a class="nav-link text-uppercase text-expanded dropdown-toggle" data-toggle="dropdown"  href="#">Žanrovi</a> 
               <ul class="dropdown-menu" role = "menu"  aria-labelledby="dLabel">
                  <li class=" dropdown-item"><a href="<?php echo site_url("Gost/muzika"); ?>">Rokenrol</a></li>
                  <li class="dropdown-item"><a href="<?php echo site_url("Gost/muzika"); ?>">Pank rok</a></li>
                  <li class="dropdown-item"><a href="<?php echo site_url("Gost/muzika"); ?>">Bluz</a></li>
                  <li class="dropdown-item"><a href="<?php echo site_url("Gost/muzika"); ?>">Narodna</a></li>
                  <li class="dropdown-item"><a href="<?php echo site_url("Gost/muzika"); ?>">Estradna</a></li>
            </ul>
          </li>
