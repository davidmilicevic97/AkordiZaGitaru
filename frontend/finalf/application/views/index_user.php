    ...
    <div class="row">
        <div class =" offset-lg-3 col-lg-6">
            <div class="alert alert-warning alert-dismissible text-center">
                ...
                <strong>Dobrodošao</strong> <?php if (isset($user)){
                        echo " $user";
                     }
                     else { echo " stranče!";}
              ?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="store.html">O Nama</a>
          </li>
          <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="store.html">Logovanje</a>
          </li>
          <li class="nav-item px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="store.html">Registracija</a>
          </li>
        </ul>
      </div>
    </div>
