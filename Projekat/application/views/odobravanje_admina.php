                    ...
                    <div class="bg-faded rounded p-5">
                        ...
                        <div class ="row">
                                ...
                                <table class ="table table-striped table-hover">
                                    ...
                                    if (isset($korisnici)) {
                                        foreach ($korisnici as $korisnik) {
                                            ...
                                            . "<td scope = 'col'><form name='searchform' action='" . site_url("Admin/dodavanjeAdmina") . "/" . $korisnik->id . "' method='post'>
                            ...
                            <div class ="col-xl-3 mx-auto">
                                ...
                                <form name="loginform" action="<?php echo site_url('Admin/odobravanjeAdmina') ?>" method="post"> <!-- umesto Gost ide admin-->
                                    <table>
                                        <tr>
                                            <td>
